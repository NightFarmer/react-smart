Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _class,_temp,_jsxFileName='src/ActionSheet/ActionSheetView.js';var _react=require('react');var _react2=_interopRequireDefault(_react);
...
ActionSheetView=(_temp=_class=function(_Component){_inherits(ActionSheetView,_Component);
...
function ActionSheetView(props){_classCallCheck(this,ActionSheetView);var _this=_possibleConstructorReturn(this,(ActionSheetView.__proto__||Object.getPrototypeOf(ActionSheetView)).call(this,
