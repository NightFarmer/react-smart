Object.defineProperty(exports,"__esModule",{value:true});var _jsxFileName='src/Toast/ToastView.js';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _react=require('react');var _react2=_interopRequireDefault(_react);
...
ToastView=function(_Component){_inherits(ToastView,_Component);





function ToastView(props){_classCallCheck(this,ToastView);var _this=_possibleConstructorReturn(this,(ToastView.__proto__||Object.getPrototypeOf(ToastView)).call(this,
