...
var _NavigationExperimental=require('../../react-native-experimental-navigation/NavigationExperimental');var _NavigationExperimental2=_interopRequireDefault(_NavigationExperimental);
...
NavigationAnimatedView=_NavigationExperimental2.default.AnimatedView,
NavigationCard=_NavigationExperimental2.default.Card;var
...
function rightToLeft(props){var
...
outputRange:[SCREEN_WIDTH,0,-SCREEN_WIDTH/3]});
...
function rightToLeftMask(props){var
...
DefaultRenderer=(_temp=_class=function(_Component){_inherits(DefaultRenderer,_Component);_createClass(DefaultRenderer,null,[{key:'getPanHandlers',value:function getPanHandlers(
...
navigationState:props.scene.navigationState,__source:{fileName:_jsxFileName,lineNumber:192}}));
...
return _react2.default.createElement(HeaderComponent,_extends({},props,navBarProps,{getTitle:getTitle,__source:{fileName:_jsxFileName,lineNumber:256}}));
...
if(!animType){
maskStyle=rightToLeftMask(props);
}
