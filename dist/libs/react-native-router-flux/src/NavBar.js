Object.defineProperty(exports,"__esModule",{value:true});var _jsxFileName='src/libs/react-native-router-flux/src/NavBar.js';var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};
...
childState,{
style:style,__source:{fileName:_jsxFileName,lineNumber:214}})));
...
_react2.default.createElement(_reactNative.Text,{style:textButtonStyle,__source:{fileName:_jsxFileName,lineNumber:232}},
...
testID:'backNavButton',
style:style,
onPress:onPress,__source:{fileName:_jsxFileName,lineNumber:238}},
...
childState.leftButtonIconStyle],__source:{fileName:_jsxFileName,lineNumber:244}}),
...
style:style,
textButtonStyle:textStyle,__source:{fileName:_jsxFileName,lineNumber:277}})));
...
testID:'rightNavButton',
style:style,
onPress:onPress,__source:{fileName:_jsxFileName,lineNumber:290}},

rightTitle&&
_react2.default.createElement(_reactNative.Text,{style:textStyle,__source:{fileName:_jsxFileName,lineNumber:297}},
rightTitle),


state.rightButtonImage&&
_react2.default.createElement(_reactNative.View,{style:{flex:1,justifyContent:'center',alignItems:'flex-end'},__source:{fileName:_jsxFileName,lineNumber:302}},
_react2.default.createElement(_reactNative.Image,{
source:state.rightButtonImage,
style:state.rightButtonIconStyle,__source:{fileName:_jsxFileName,lineNumber:303}}))));
...
style:style,
textStyle:textStyle,__source:{fileName:_jsxFileName,lineNumber:343}})));
...
_react2.default.createElement(_reactNative.Image,{
source:buttonImage,
style:leftButtonStyle,__source:{fileName:_jsxFileName,lineNumber:361}});
...
testID:'leftNavButton',
style:style,
onPress:onPress,__source:{fileName:_jsxFileName,lineNumber:372}},

leftTitle&&
_react2.default.createElement(_reactNative.Text,{style:textStyle,__source:{fileName:_jsxFileName,lineNumber:379}},
leftTitle),


buttonImage&&
_react2.default.createElement(_reactNative.View,{style:{flex:1,justifyContent:'center',alignItems:'flex-start'},__source:{fileName:_jsxFileName,lineNumber:384}},
menuIcon||_react2.default.createElement(_reactNative.Image,{
source:buttonImage,
style:state.leftButtonIconStyle||styles.defaultImageStyle,__source:{fileName:_jsxFileName,lineNumber:385}}))));
...
style:[
styles.titleWrapper,
this.props.titleWrapperStyle],__source:{fileName:_jsxFileName,lineNumber:415}},
...
inputRange:[index-1,index+1],
outputRange:[-200,200]})}],__source:{fileName:_jsxFileName,lineNumber:422}}),
...
return function(props){return _react2.default.createElement(_reactNative.View,{style:wrapStyle,__source:{fileName:_jsxFileName,lineNumber:464}},component(props));};
};
...
var contents=
_react2.default.createElement(_reactNative.View,{__source:{fileName:_jsxFileName,lineNumber:485}},
...
selected.navigationBarStyle],__source:{fileName:_jsxFileName,lineNumber:492}},


navigationBarBackgroundImage?
_react2.default.createElement(_reactNative.Image,{source:navigationBarBackgroundImage,__source:{fileName:_jsxFileName,lineNumber:501}},
contents):
