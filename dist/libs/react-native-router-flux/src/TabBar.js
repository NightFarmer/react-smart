Object.defineProperty(exports,"__esModule",{value:true});var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();var _class,_temp,_jsxFileName='src/libs/react-native-router-flux/src/TabBar.js';var _react=require('react');var _react2=_interopRequireDefault(_react);
...
TabBar=(_temp=_class=function(_Component){_inherits(TabBar,_Component);_createClass(TabBar,null,[{key:'onSelect',value:function onSelect(
...
navigationState:navigationState,__source:{fileName:_jsxFileName,lineNumber:43}}));
...
pressOpacity:this.props.pressOpacity,__source:{fileName:_jsxFileName,lineNumber:60}}),
...
return _react2.default.createElement(Icon,_extends({},_this2.props,el,{__source:{fileName:_jsxFileName,lineNumber:70}}));
}));


return(
_react2.default.createElement(_reactNative.View,{
style:{flex:1},__source:{fileName:_jsxFileName,lineNumber:75}},

_react2.default.createElement(_TabbedView2.default,{
navigationState:this.props.navigationState,
style:{flex:1},
renderScene:this.renderScene,__source:{fileName:_jsxFileName,lineNumber:78}}),

!hideTabBar&&state.children.filter(function(el){return el.icon;}).length>0&&(
state.tabBarBackgroundImage?
_react2.default.createElement(_reactNative.Image,{source:state.tabBarBackgroundImage,__source:{fileName:_jsxFileName,lineNumber:85}},
contents):
...
}}]);return TabBar;}(_react.Component),_class.propTypes={navigationState:_propTypes2.default.object,tabIcon:_propTypes2.default.any,onNavigate:_propTypes2.default.func,unmountScenes:_propTypes2.default.bool,pressOpacity:_propTypes2.default.number,hideOnChildTabs:_propTypes2.default.bool},_temp);exports.default=
