...
import NavigationExperimental from '../../react-native-experimental-navigation/NavigationExperimental';
...
const styles = StyleSheet.create({
    animatedView: {
        flex: 1,
        backgroundColor: 'transparent',//原始
        // backgroundColor: '#000',//使用黑色
    },
    sceneStyle: {
        flex: 1,
    },
...
function rightToLeft(/* NavigationSceneRendererProps */ props) {
    const {
        position,
        scene,
    } = props;
...
function rightToLeftMask(/* NavigationSceneRendererProps */ props) {
    const {
        position,
        scene,
    } = props;
